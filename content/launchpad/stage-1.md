...
| A successful understanding of user needs ensures that: 1. The team is working on the right problems and building the right solutions. 2. The team can make good implementation decisions and ultimately deliver solutions that meet user needs. |
| :---- |
...
1. A summary of the research that you’ve conducted directly with users

2. Overviews for each Primary User Group including the problems they face
...
| Identifying clear problems and success criteria ensures that: 1. Everyone is in agreement about what the project is intended to accomplish. 2. The team is focused on the outcomes they need to achieve, not simply delivering a specific solution. This allows them to consider the problem holistically—not just from a technology perspective—and gives them the knowledge to make good implementation decisions and pivot as necessary. 3. Your agency’s impacted programs are engaged in the project and working with the technical team to achieve the desired outcomes. 4. The state is investing in solving the highest priority problems. 5. There is a clear end-state to the MITDP. |
| :---- |
...
| :---- | :---- |
| One or more specific user needs are named. <br>Some examples: <ul><li>**Caseworkers <u>spend hours each day uploading paper documents</u>, reducing the amount of time available to spend with their clients**</li><li>**60% of applications are abandoned because <u>users can’t save and return later</u>**</li><li>**Field staff <u>working in rural areas are unable to do their jobs</u> due to poor internet access and a lack offline functionality among current tools**</li> | Technical or bureaucratic changes that aren't based on research with users. <br>Some examples:<ul><li class="wrong-red">***Replace our outdated, legacy system with modern technology***</li><li class="wrong-red">***Migrate to a cloud-based COTS system***</li><li class="wrong-red">***Establish a unified portal for intake and standardization***</li>   |
